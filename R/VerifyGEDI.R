...
#'
#' If the FSS algorithm selects two or more features, \code{VerifyGEDI}
#' constructs a scatterplot using the first two features as axes. The scatterplot
#' visualises how well the model can separate the samples based on the \code{y}
#' variable.
#'
#' @return
...
#' @importFrom ggplot2 ggplot geom_point xlab ylab ggtitle aes_string
#'
#' @seealso
#' \code{\link{ReadGE}}
#' \code{\link{GEDI}}
